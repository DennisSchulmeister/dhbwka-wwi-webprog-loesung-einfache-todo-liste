# Webprogrammierung / Lösung / Einfache TODO-Liste

Dies ist die **Musterlösung** zur Aufgabe „Einfache TODO-Liste" aus der Vorlesung **Webprogrammierung** (Wirtschaftsinformatik, DHBW Karlsruhe), Kategorie *JavaScript*.
